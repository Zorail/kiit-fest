...
//                    c.setId(getIntent().getStringExtra("id"));
//                    c.setName(getIntent().getStringExtra("name"));
//                    c.setTimestamp(getIntent().getStringExtra("timestamp"));
//                    c.setUnreadCount(0);
//                    c.setLastMessage("");
//                    chatRoomArrayList.add(c);
//                }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.action_new_room:
                MyApplication.getInstance().createChatRoom();
                break;
        }
